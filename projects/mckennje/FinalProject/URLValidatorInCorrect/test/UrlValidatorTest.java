...
//        assertTrue(validator.isValid("http://test.xn--hlcj6aya9esc7a")); // Tamil
   ...
   ResultPair[] testScheme = {new ResultPair("http", true),
	...
	public void testIsValidAgain() {
		...
		for (int i = 0; i < unitTestUrlScheme.length; i++) {
			for (int j = 0; j < unitTestUrlAuth.length; j++) {
				for (int k = 0; k < unitTestUrlPath.length; k++) {
					for (int l = 0; l < unitTestUrlQuery.length; l++) {
						url = unitTestUrlScheme[i].item
								+ unitTestUrlAuth[j].item
								+ unitTestUrlPath[k].item
								+ unitTestUrlQuery[l].item;

						// If all components are valid, expect URL is valid;
						// if any component is invalid, expect URL is invalid.
						expect = unitTestUrlScheme[i].valid
								&& unitTestUrlAuth[j].valid
								&& unitTestUrlPath[k].valid
								&& unitTestUrlQuery[l].valid;
	...
	//////////////////////////////////
	ResultPair[] unitTestUrlScheme = {new ResultPair("http://", true),
	...
	ResultPair[] unitTestUrlAuth = {new ResultPair("www.google.com", true),
	...
	ResultPair[] unitTestUrlPath = {new ResultPair("/test", true),
			new ResultPair("/test1", true),
	...
	ResultPair[] unitTestUrlQuery = {new ResultPair("?action=view", true),
			new ResultPair("?action=edit&mode=up", true),
